...
var IERC20 = artifacts.require('./BattleCraft.sol');

contract('BattleCraft', function([ _, wallet, wallet2 ]) {

  before(async function () {
    this.token =  await IERC20.new("200000000000000000000000000");
  }); 
  ...
  describe('Contract has instantiated correctly', function() {
    it('asserts all constructor params', async function() {
      ...
      name.should.be.equal( "BattleCraft" );

      const totalSupply = await this.token.totalSupply();
      totalSupply.should.be.bignumber.equal( toBN("200000000000000000000000000") );
  ...
  describe('Transfer Scenarios', function() {
    it('Balance of should work as expected', async function() {
      ...
      balance.should.be.bignumber.equal( toBN("200000000000000000000000000") );
    });
